(() => {
  ...
  if (!window.navigator.userAgent.match(/Trident\/7\./, [])) {
    ...
    !(function () {
      const e = window.navigator,
        ...
        i = !(!e.mediaCapabilities || !e.mediaCapabilities.decodingInfo);
      return (
        -1 != t.indexOf("safari") &&
        !(-1 != t.indexOf("chrome")) &&
        -1 != t.indexOf("version/") &&
      ...
      ? e.forEach((e) => {
          ...
          (t += "webm"), e.setAttribute("src", t);
        })
      : e.forEach((e) => {
          let t = e.getAttribute("src");
          (t += "mov"),
            e.setAttribute("src", t),
            e.setAttribute("type", "video/quicktime");
        });
  }
          ...
          void 0 !== n &&
            ...
            (S(e[s]) && S(r[s])
              ? r[s].__swiper__
                ...
                : T(e[s], r[s])
              : !S(e[s]) && S(r[s])
              ? ((e[s] = {}), r[s].__swiper__ ? (e[s] = r[s]) : T(e[s], r[s]))
              : (e[s] = r[s]));
        }
      }
    }
  ...
  var H = {
    updateSize: function () {
      ...
      (t =
        ...
        (0 === t && e.isHorizontal()) ||
          ...
          ((t =
            t -
            parseInt(L(s, "padding-left") || 0, 10) -
            parseInt(L(s, "padding-right") || 0, 10)),
          (i =
            i -
            parseInt(L(s, "padding-top") || 0, 10) -
            parseInt(L(s, "padding-bottom") || 0, 10)),
          Number.isNaN(t) && (t = 0),
          Number.isNaN(i) && (i = 0),
          Object.assign(e, {
            width: t,
    ...
    updateSlides: function () {
      ...
      "string" == typeof S && S.indexOf("%") >= 0
        ...
        i.centeredSlides &&
          i.cssMode &&
          (b(s, "--swiper-centered-offset-before", ""),
          b(s, "--swiper-centered-offset-after", ""));
      ...
      for (let s = 0; s < u; s += 1) {
        ...
        if (
          ...
          !c[s] || "none" !== L(r, "display"))
        ) {
          if ("auto" === i.slidesPerView) {
            k && (c[s].style[e.getDirectionLabel("width")] = "");
            ...
            if (
              ...
              C = e.isHorizontal() ? P(r, "width", !0) : P(r, "height", !0);
            else {
              const e = t(n, "width"),
                i = t(n, "padding-left"),
                s = t(n, "padding-right"),
            ...
            (C = (n - (i.slidesPerView - 1) * S) / i.slidesPerView),
              i.roundLengths && (C = Math.floor(C)),
              c[s] && (c[s].style[e.getDirectionLabel("width")] = `${C}px`);
      ...
      if (
        ...
        b(s, "--swiper-centered-offset-before", -p[0] + "px"),
          b(
            s,
    ...
    updateSlidesProgress: function (e) {
      ...
      for (let e = 0; e < s.length; e += 1) {
        ...
        f && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e)),
          W(l, f, i.slideVisibleClass),
          W(l, m, i.slideFullyVisibleClass),
          (l.progress = r ? -c : c),
      ...
      l &&
        ...
        t.forEach((e) => {
          R(e, e === l, i.slideActiveClass),
            R(e, e === c, i.slideNextClass),
            R(e, e === d, i.slidePrevClass);
        }),
        e.emitSlidesClasses();
    },
    updateActiveIndex: function (e) {
      ...
      if ((l >= s.length && (l = s.length - 1), d === n && !t.params.loop))
  ...
  var q = {
    slideTo: function (e, t, i, s, r) {
      ...
      if (!(S && r) && ((p && -v === n.translate) || (!p && v === n.translate)))
        return (
      ...
      if (r.params.loop)
        if (r.virtual && r.params.virtual.enabled) o += r.virtual.slidesBefore;
          ...
          if (
            ...
            s && i && "auto" !== r.params.slidesPerView && !n && (l = !1),
            l)
          ) {
            const s = i
              ? e < r.activeIndex
        ...
        (r = parseInt(
          ...
          t.centeredSlides
            ? n < e.loopedSlides - s / 2 ||
              ...
              ? (e.loopFix(),
                (n = e.getSlideIndex(
                  E(i, `${o}[data-swiper-slide-index="${r}"]`)[0]
                )),
                g(() => {
                  e.slideTo(n);
                }))
  ...
  function X(e) {
    ...
    if ("touchstart" === s.type) return void Y(t, s, s.targetTouches[0].pageX);
    ...
    l.matches(r.focusableElements) &&
      ...
      i.activeElement &&
        ...
        i.activeElement !== l &&
        ("mouse" === s.pointerType ||
          ("mouse" !== s.pointerType && !l.matches(r.focusableElements))) &&
  ...
  function U(e) {
    ...
    if (!s.isMoved) {
      if (
        (S && T && i.loopFix({ direction: i.swipeDirection }),
  ...
  function K(e) {
    ...
    for (
      ...
      void 0 !== l[e + t]
        ? (h || (p >= l[e] && p < l[e + t])) && ((m = e), (f = l[e + t] - l[e]))
        : (h || p >= l[e]) &&
    ...
    if (u > n.longSwipesMs) {
      ...
      "next" === t.swipeDirection &&
        (T >= n.longSwipesRatio
          ? t.slideTo(n.rewind && t.isEnd ? w : m + b)
          : t.slideTo(m)),
      ...
      (r.target === t.navigation.nextEl || r.target === t.navigation.prevEl)
        ? r.target === t.navigation.nextEl
          ? t.slideTo(m + b)
          : t.slideTo(m)
        : ("next" === t.swipeDirection && t.slideTo(null !== w ? w : m + b),
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          const h = a.direction && a.direction !== s.direction,
            ...
            f = s.loop;
          h && i && e.changeDirection(), T(e.params, a);
    ...
    mount(e) {
      ...
      return (
        ...
        Object.assign(t, {
          ...
          mounted: !0,
          rtl: "rtl" === i.dir.toLowerCase() || "rtl" === L(i, "direction"),
          rtlTranslate:
            "horizontal" === t.params.direction &&
            ("rtl" === i.dir.toLowerCase() || "rtl" === L(i, "direction")),
  ...
  function de(e) {
    ...
    i({
      ...
      s("click", (e, i) => {
        ...
        (s = k(s)), (n = k(n));
        const o = i.target;
        let a = n.includes(o) || s.includes(o);
        if (t.isElement && !a) {
          const e = i.path || (i.composedPath && i.composedPath());
          e && (a = e.find((e) => s.includes(e) || n.includes(e)));
        }
  ...
  class he {
    advance(e) {
      ...
      if (this.lerp)
        ...
        this.currentTime += e;
        const i = pe(0, this.currentTime / this.duration, 1);
        t = i >= 1;
        const s = t ? 1 : this.easing(i);
  ...
  class ve {
    ...
    onWheel = (e) => {
      ...
      (t *= 1 === s ? ge : 2 === s ? this.windowWidth : 1),
        (i *= 1 === s ? ge : 2 === s ? this.windowHeight : 1),
  ...
  class we {
    constructor({
      ...
      (this.__isSmooth = !1),
        ...
        (this.__isStopped = !1),
        (this.__isLocked = !1),
        (this.onVirtualScroll = ({ deltaX: e, deltaY: t, event: i }) => {
          if (i.ctrlKey) return;
              ...
              return (
                ...
                (s &&
                  (null === (i = e.hasAttribute) || void 0 === i
                    ? void 0
                    : i.call(e, "data-lenis-prevent-touch"))) ||
                (r &&
                  (null === (n = e.hasAttribute) || void 0 === n
                    ? void 0
                    : n.call(e, "data-lenis-prevent-wheel"))) ||
          ...
          const d = s && this.options.syncTouch,
            c = s && "touchend" === i.type && Math.abs(l) > 5;
        ...
        (this.animate = new he()),
        (this.emitter = new fe()),
        (this.dimensions = new me({ wrapper: e, content: t, autoResize: g })),
  ...
  (window.onRefreshLenisScroll = () => {
    ...
    !t.any() && window.onRefreshLenisScroll();
  const Se = document.querySelectorAll("[data-fixed]"),
    Te = document.querySelectorAll("[data-fixed-el]");
  document
    .querySelectorAll("[data-coffee]")
    .forEach((e, t) => (e.style.animationDelay = `0.${t}s`));
  const be = new IntersectionObserver(
    ...
    { root: null, rootMargin: "0px 0px -100%", threshold: 0 }
  );
  Se.forEach((e) => {
    be.observe(e);
  }),
    ...
    (function () {
      const e = document.querySelectorAll("[data-clipboardBtn]");
      e.length &&
        e.forEach((e) => {
          e.addEventListener("click", () => {
            const t = e.closest("[data-clipboard]");
            if (t) {
              const i = t
                  .querySelector("[data-clipboardEl]")
                  .textContent.trim(),
                s = t.querySelector("[data-cnHint]");
              async function r(e) {
                try {
        ...
        if ("click" === t.type) {
          ...
          if (i.closest("[data-goto]")) {
            const s = i.closest("[data-goto]"),
              r = s.dataset.goto ? s.dataset.goto : "",
